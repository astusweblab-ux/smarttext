...
const UI_TEXT = {
  ru: {
    ...
    helpForWhatText: 'SmartText помогает быстро редактировать текст прямо в браузере: исправлять ошибки, сокращать, расширять, менять тон и переводить. Основные AI-операции выполняются локально через Chrome Built-in AI без API-ключей.',
    ...
    helpFeature7: 'Использовать голосовой ввод, загружать файлы txt/md/docx/pdf и настраивать темы интерфейса',
  ...
  en: {
    ...
    helpForWhatText: 'SmartText helps you edit text faster right in the browser: fix mistakes, shorten, expand, adjust tone, and translate. Core AI editing runs locally via Chrome Built-in AI without API keys.',
    ...
    helpFeature7: 'Use voice input, upload txt/md/docx/pdf files, and customize themes',
...
const UI_TEXT_TRANSLATIONS = {
  es: {
    ...
    helpForWhatText: 'SmartText te ayuda a editar texto más rápido en el navegador: corrige errores, acorta, amplía, cambia el tono y traduce. Las funciones principales de AI funcionan localmente con Chrome Built-in AI sin API keys.',
    ...
    helpFeature7: 'Usar entrada por voz, cargar archivos txt/md/docx/pdf y personalizar temas',
  ...
  de: {
    ...
    helpForWhatText: 'SmartText hilft dir, Texte im Browser schneller zu bearbeiten: Fehler korrigieren, kürzen, erweitern, Ton ändern und übersetzen. Die zentralen AI-Funktionen laufen lokal mit Chrome Built-in AI ohne API-Schlüssel.',
    ...
    helpFeature7: 'Spracheingabe nutzen, txt/md/docx/pdf hochladen und Themes anpassen',
  ...
  fr: {
    ...
    helpForWhatText: 'SmartText vous aide à éditer du texte plus vite dans le navigateur : corriger des erreurs, raccourcir, développer, ajuster le ton et traduire. Les fonctions AI principales s’exécutent localement via Chrome Built-in AI sans clé API.',
    ...
    helpFeature7: 'Utiliser la dictée vocale, charger des fichiers txt/md/docx/pdf et personnaliser les thèmes',
  ...
  it: {
    ...
    helpForWhatText: 'SmartText ti aiuta a modificare testi più velocemente nel browser: correggere errori, accorciare, espandere, cambiare tono e tradurre. Le funzioni AI principali funzionano in locale tramite Chrome Built-in AI senza API key.',
    ...
    helpFeature7: 'Usare input vocale, caricare file txt/md/docx/pdf e personalizzare i temi',
  ...
  pt: {
    ...
    helpForWhatText: 'O SmartText ajuda você a editar textos mais rápido no navegador: corrigir erros, encurtar, expandir, ajustar tom e traduzir. As funções principais de AI funcionam localmente com Chrome Built-in AI sem chave API.',
    ...
    helpFeature7: 'Usar voz, enviar arquivos txt/md/docx/pdf e personalizar temas',
  ...
  ja: {
    ...
    helpForWhatText: 'SmartTextはブラウザ内でテキスト編集を高速化します。誤り修正、短縮、拡張、トーン調整、翻訳に対応します。主要なAI編集はChrome Built-in AIでローカル実行され、APIキーは不要です。',
    ...
    helpFeature7: '音声入力、txt/md/docx/pdf 読込、テーマのカスタマイズ',
  ...
  uk: {
    ...
    helpForWhatText: 'SmartText допомагає швидко редагувати текст у браузері: виправляти помилки, скорочувати, розширювати, змінювати тон і перекладати. Основні AI-функції працюють локально через Chrome Built-in AI без API-ключів.',
    ...
    helpFeature7: 'Використовувати голосове введення, завантаження txt/md/docx/pdf і налаштування тем',
  ...
  pl: {
    ...
    helpForWhatText: 'SmartText pomaga szybciej edytować tekst w przeglądarce: poprawiać błędy, skracać, rozwijać, zmieniać ton i tłumaczyć. Główne funkcje AI działają lokalnie przez Chrome Built-in AI bez kluczy API.',
    ...
    helpFeature7: 'Wprowadzanie głosowe, pliki txt/md/docx/pdf i personalizacja motywów',
